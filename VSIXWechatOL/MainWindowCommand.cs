...
namespace VSIXWechatOL
{
    ...
    internal sealed class MainWindowCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("19e3163b-5814-4b4d-ad51-59b18e30ff95");
        ...
        {
            // Verify the current thread is the UI thread - the call to AddCommand in MainWindowCommand's constructor requires
            // the UI thread.
