...
namespace WeChatOL
{
    ...
    internal sealed class ToolWindow1Command
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("844cef4d-6093-447e-9cb9-097646e84522");
        ...
        {
            // Verify the current thread is the UI thread - the call to AddCommand in ToolWindow1Command's constructor requires
            // the UI thread.
